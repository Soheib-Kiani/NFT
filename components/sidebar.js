...
const sidebar = () => {
  return (
    <div className="min-h-screen bg-black text-sm w-52 font-jost border-r-2 border-r-yellow-300 ">
      ...
      {/* Marketplace Buttons */}
      <p className="text-white pl-1 font-extralight mt-5 uppercase">marketplace</p>
      ...
      <div className="grid place-items-center gap-y-1">
        {/* #1 */}
        <div className="flex w-full mt-3 items-start px-5 gap-x-3 text-center">
          <img src="/side-icon/Plus.png" alt="img" />
          <p className="text-white">Upload New</p>
        </div>
        {/* #2 */}
        <div className="flex w-full mt-3 items-start px-5 gap-x-3 text-center">
          <img src="/side-icon/Download.png" alt="img" />
          <p className="text-white">Import NFT</p>
        </div>
        {/* #3 */}
        <div className="flex w-full mt-3 items-start px-5 gap-x-3 text-center">
          <img src="/side-icon/Paper Negative.png" alt="img" />
      ...
      <div className="grid place-items-center gap-y-1">
        {/* #1 */}
        <div className="flex w-full mt-3 items-start px-5 gap-x-3 text-center">
          <img src="/side-icon/Play.png" alt="img" />
          <p className="text-white">Sample Music</p>
        </div>
        {/* #2 */}
        <div className="flex w-full mt-3 items-start px-5 gap-x-3 text-center">
          <img src="/side-icon/Voice.png" alt="img" />
          <p className="text-white">Your Top Songs</p>
        </div>
        {/* #3 */}
        <div className="flex w-full mt-3 items-start px-5 gap-x-3 text-center">
          <img src="/side-icon/Discovery.png" alt="img" />
      ...
      <div className="grid place-items-center gap-y-1">
        {/* #1 */}
        <div className="flex w-full mt-3 items-start px-5 gap-x-3 text-center">
          <img src="/side-icon/Setting.png" alt="img" />
          <p className="text-white">Setting</p>
        </div>
        {/* #2 */}
        <div className="flex w-full mt-3 items-start px-5 gap-x-3 text-center">
          <img src="/side-icon/Logout.png" alt="img" />
